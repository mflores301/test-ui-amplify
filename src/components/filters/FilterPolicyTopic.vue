...
const items = [
  { label: 'All', value: 'topic_all' },
  { label: 'Anesthesia', value: 'topic_anesthesia' },
  { label: 'Behavioral Health', value: 'topic_behavioral_health' },
  { label: 'Chiropractic', value: 'topic_chiropracter' },
  { label: 'Drugs and Biologicals', value: 'topic_drugs_biologicals' },
  { label: 'Gastroenterology', value: 'topic_gastroenterology' },
  { label: 'Laboratory', value: 'topic_lab' },
  { label: 'Neurology', value: 'topic_neurology' },
  { label: 'Radiology', value: 'topic_radiology' },
  { label: 'Surgery', value: 'topic_surgery' },
  { label: 'Telehealth', value: 'topic_telehealth' },
]
...
<template>
  <div ref="root" class="relative inline-block">
    ...
    >
      <FilterMenu title="Policy Topics" @close="open = false" @clear="clearFilters()">
        <ul class="p-1">

...
export const useEditTypes = defineStore('dbEditTypes', () => {
  const loading = ref(false)

  const editTypes = useStorage('@rialtic/demo:edit_types', [] as EditType[])
  ...
  const update = async(dbUpdates: Partial<EditType>, id: string) => {
...
if (import.meta.hot)
  import.meta.hot.accept(acceptHMRUpdate(useEditTypes, import.meta.hot))
